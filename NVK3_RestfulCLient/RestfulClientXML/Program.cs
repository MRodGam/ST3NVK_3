...
namespace RestfulClientXML
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ConcertEquipment e = new ConcertEquipment()
            {
                EquipmentId = 0,
            ...
            ConcertEquipment f = new ConcertEquipment()
            {
                EquipmentId = 0,
                EquipmentName = "Gibson",
            ...
            ConcertEquipment g = new ConcertEquipment()
            {
                EquipmentId = 0,
            ...
            g.EquipmentId = 200;
            g = myConsertEquipmentUtilXML.GetConcertEquip(g);
            myConsertEquipmentUtilXML.DeleteConcertEquipment(g);
            //200
